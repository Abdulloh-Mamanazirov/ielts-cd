...
function CompletionBody({
  ...
  return (
    <div className="question-body leading-8 text-ink [&_ul]:list-disc [&_ul]:pl-5 [&_li]:py-1 [&_.notes-title]:mb-3 [&_.notes-title]:text-center [&_.notes-title]:text-[1.05em] [&_.notes-title]:font-bold [&_.sub-head]:mb-1 [&_.sub-head]:mt-5 [&_.sub-head]:font-bold [&_.sub-head]:text-ink [&_.flow-arrow]:my-1 [&_.flow-arrow]:text-center [&_.flow-arrow]:text-brand-blue [&_.flow-box]:rounded-md [&_.flow-box]:bg-surface-alt [&_.flow-box]:px-4 [&_.flow-box]:py-3 [&_.form-label]:font-semibold [&_.form-row]:flex [&_.form-row]:flex-wrap [&_.form-row]:gap-x-3 [&_.form-row]:border-b [&_.form-row]:border-rule [&_.form-row]:py-2 [&_.notes-list]:list-disc [&_.notes-list]:pl-5 [&_.q-table]:w-full [&_.q-table_td]:border [&_.q-table_td]:border-rule [&_.q-table_td]:p-2.5 [&_.q-table_th]:border [&_.q-table_th]:border-rule [&_.q-table_th]:bg-surface-alt [&_.q-table_th]:p-2.5 [&_.q-table_th]:text-left [&_.summary-title]:mb-2 [&_.summary-title]:font-bold [&_.word-box]:mb-4 [&_.word-box]:flex [&_.word-box]:flex-wrap [&_.word-box]:gap-2 [&_.word-box]:rounded-lg [&_.word-box]:bg-surface-alt [&_.word-box]:p-3 [&_.word-box>span]:rounded-md [&_.word-box>span]:bg-white [&_.word-box>span]:px-3 [&_.word-box>span]:py-1.5 [&_.word-box>span]:text-[0.95em] [&_.word-box>span]:shadow-[inset_0_0_0_1px_rgba(11,17,32,.12)]">
