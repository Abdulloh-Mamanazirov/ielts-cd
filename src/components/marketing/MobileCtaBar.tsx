...
/**
 * Pinned primary action on phones, per the 1a mobile spec: the mock-test CTA
 * fills the bar with the free-practice play button beside it. Hidden from large
 * screens, where the hero buttons are always reachable.
 */
